This small project contains examples of using dataformat-xml. The purpose of the examples is to show how to write one code to parse both XML and JSON documents.
